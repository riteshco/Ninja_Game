...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption('Ritesh: The Ninja!!')
        self.screen = pygame.display.set_mode((1720, 1080))
        self.display = pygame.Surface((860, 540) , pygame.SRCALPHA)
        self.display_2 = pygame.Surface((860 , 540))
        ...
        self.assets = {
            ...
            'background2':load_image('background5.JPG')
        }
    ...
    def run(self):
        pygame.mixer.music.load('ninja_data/Minecraft.mp3')
